  ...
  return (
    <section className="py-[120px] bg-[#0F172A] relative overflow-hidden">
      ...
      <div className="max-w-[1000px] mx-auto px-6 text-center relative z-10">
        ...
        <button onClick={() => router.push('/contact')} className="bg-[#F97316] text-white px-10 py-5 rounded-md font-bold text-xl hover:bg-[#ea580c] transition-colors shadow-[0_4px_20px_rgba(249,115,22,0.4)] mb-8">
          Request a Quote
        </button>
